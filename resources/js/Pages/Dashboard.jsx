                        ...
                        <div className="bg-gray-50 p-8 border border-gray-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white p-6 border border-gray-100 text-center hover:shadow-sm transition-shadow">
                                    <h3 className="text-[#7C634D] font-medium mb-2 uppercase tracking-wide text-sm">Total Orders</h3>
                                    <p className="text-3xl font-light text-gray-800">0</p>
                                </div>
                                <div className="bg-white p-6 border border-gray-100 text-center hover:shadow-sm transition-shadow">
                                    <h3 className="text-[#7C634D] font-medium mb-2 uppercase tracking-wide text-sm">Pending</h3>
                                    <p className="text-3xl font-light text-gray-800">0</p>
                                </div>
                                <div className="bg-white p-6 border border-gray-100 text-center hover:shadow-sm transition-shadow">
                                    <h3 className="text-[#7C634D] font-medium mb-2 uppercase tracking-wide text-sm">Completed</h3>
                                    <p className="text-3xl font-light text-gray-800">0</p>
                                </div>
                            </div>
                        </div>
