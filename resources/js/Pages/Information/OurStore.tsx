        ...
        <div className="max-w-4xl mx-auto px-6 md:px-16 py-16 md:py-24">
          ...
          <div className="prose max-w-none text-[#7C634D]">
            <div className="bg-[#FFF6EC] p-8 rounded-lg text-center mb-12">
              ...
              <p className="mb-4">
                JuneLabel primarily operates as an online store, serving customers throughout
                Indonesia. We are dedicated to providing you with the best shopping experience from
                the comfort of your home.
              </p>
              <div className="flex justify-center gap-4 mt-6">
                <a
                  href="https://shopee.co.id/junelabel"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-2 border border-[#7C634D] rounded hover:bg-[#7C634D] hover:text-white transition-colors"
                >
                  Shopee
                </a>
                <a
                  href="https://tokopedia.com/junelabel"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-2 border border-[#7C634D] rounded hover:bg-[#7C634D] hover:text-white transition-colors"
                >
            ...
            <div className="text-center">
              ...
              <p className="mb-4">
                Currently, we do not have a permanent offline store. However, we frequently
                participate in bazaars and pop-up events. Follow our social media to stay updated on
