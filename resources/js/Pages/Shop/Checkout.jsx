...
import { ArrowLeft, CheckCircle, PackageSearch, Truck } from 'lucide-react';
...
export default function Checkout() {
  ...
  const calculateShippingCosts = async (districtId) => {
    ...
    try {
      ...
      const totalWeight = cartItems.reduce((sum, item) => {
        const productWeight = item.weight || 200; // grams
