    ...
    <div className="min-h-screen flex flex-col bg-[#FFF6EC] font-inter">
      ...
      <main className="flex-grow pt-24 pb-16 px-4 md:px-8 lg:px-16 container mx-auto">
        <div className="flex items-center gap-2 mb-8 text-[#7C634D]">
          ...
          <h1 className="text-2xl md:text-3xl font-serif font-bold tracking-wide uppercase">
            Shopping Cart
          </h1>
        </div>
        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-[#7C634D]/70 mb-8 max-w-md">
              Looks like you haven't added anything to your cart yet. Explore our collections to
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            ...
            <div className="w-full lg:w-2/3 space-y-6">
              ...
              {cartItems.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-4 py-4 border-b border-[#7C634D]/10 items-center"
                  >
                    {/* Product Info */}
                    ...
                    <div className="col-span-1 md:col-span-2 flex items-center md:justify-center gap-3">
                      ...
                      <span className="w-8 text-center font-medium text-[#7C634D]">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() => updateQuantity(item.id, item.quantity + 1)}
            ...
            <div className="w-full lg:w-1/3 h-fit bg-white p-6 md:p-8 border border-[#7C634D]/10 sticky top-24">
              <h3 className="font-serif text-xl text-[#7C634D] mb-6 border-b border-[#7C634D]/10 pb-4">
                Order Summary
              </h3>
