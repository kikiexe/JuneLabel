...
export default function Navbar() {
	...
	return (
        ...
        `}
			...
			<nav
				className="font-inter py-3 px-6 xl:px-16 sticky top-0 left-0 w-full z-50 transition-all duration-300 shadow-sm"
				style={{
			...
			>
				<div className="w-full flex items-center justify-between relative">
					<div className="hidden xl:flex items-center gap-10 flex-1">
						<NavLink href="/new-arrival" onClick={handleDevFeature}>
							NEW ARRIVAL
						</NavLink>
						<NavLink href="/best-seller" onClick={handleDevFeature}>
							BEST SELLER
						</NavLink>
