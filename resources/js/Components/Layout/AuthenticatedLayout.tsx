...
import { useState, ReactNode, PropsWithChildren, FormEvent } from 'react';
...
export default function AuthenticatedLayout({
  ...
  const inertiaUser = auth.user;

  // Fallback user object matching User interface
  ...
  const user = propUser || inertiaUser || guestUser;
