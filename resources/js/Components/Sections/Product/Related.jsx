        ...
        <section className="py-20 px-6 max-w-[1920px] mx-auto w-full border-t bg-[#FFFFFF]">
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 lg:grid lg:grid-cols-4 lg:gap-8 lg:overflow-visible no-scrollbar pb-6 lg:pb-0 -mx-6 px-6 lg:mx-0 lg:px-0">
                {products.map((product) => {
                    ...
                    return (
                        <div key={product.id} className="group cursor-pointer min-w-[200px] w-[75%] md:w-[45%] lg:w-auto flex-shrink-0 snap-center lg:snap-align-none">
                            <Link href={route('product.detail', product.slug)}>
                                <div className="relative overflow-hidden mb-4 bg-[#F5F5F5] w-full" style={{ paddingBottom: '133.33%' }}>
                                    <img 
                                ...
                                <div className="text-center space-y-1">
                                    <h3 
                                        className="text-xs md:text-sm font-bold tracking-widest uppercase text-[#7C634D] line-clamp-1"
                                    >
                                        {product.name}
                                    </h3>
