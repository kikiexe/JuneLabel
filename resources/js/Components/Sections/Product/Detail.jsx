                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
                    ...
                    <div className="w-full lg:w-[60%] relative group">
                        ...
                        >
                            {allImages.map((img, index) => (
                                <div 
                                    key={index} 
                                    className="w-full flex-shrink-0 snap-center bg-[#f9f9f9] relative"
                                >
                                    <img 
                                        src={`/storage/${img}`} 
                    ...
                    <div className="w-full lg:w-[40%] flex flex-col lg:sticky lg:top-24 h-fit pt-2">
                        ...
                        <div className="text-xs md:text-sm text-gray-600 font-light leading-relaxed mb-8 space-y-4">
                            <p>
                                <strong>Detail Produk:</strong><br/>
                        ...
                        <div className="mb-8 p-4 bg-[#FFF6EC] rounded-sm border border-[#7C634D]/10">
                            <h4 className="text-xs font-bold uppercase tracking-widest text-[#7C634D] mb-3 text-center">Size Chart</h4>
                            {/* Placeholder Chart - using CSS grid for table look */}
                        ...
                        <div className="space-y-6 text-xs text-gray-500 font-light mb-8 border-t border-b border-gray-100 py-6">
                            ...
                            <div>
                                ...
                                <p>Warna produk pada model memiliki tone warna yang mungkin sedikit berbeda karena faktor pencahayaan saat pemotretan.</p>
                            </div>
                        </div>
