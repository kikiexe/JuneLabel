...
export default function Alert({ isOpen, onClose, message = "Fitur masih berada dalam masa pengembangan" }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 sm:px-0">
            ...
            <div className="relative bg-[#FFF6EC] rounded-2xl shadow-xl border border-[#7C634D]/20 p-8 w-full max-w-md transform transition-all duration-300 ease-out scale-100 opacity-100 flex flex-col items-center justify-center text-center">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-[#7C634D] font-inter mb-2">
                    Coming Soon
                </h3>

                {/* Message */}
                <p className="text-[#9C8570] font-inter mb-6">
                    {message}
                </p>
