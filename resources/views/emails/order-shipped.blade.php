                ...
                <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" align="center" width="560" style="margin: auto; max-width: 560px; width: 100%; background: #FFFFFF;">
                    ...
                    <tr>
                        <td style="padding: 72px 64px 48px; font-family: 'Cormorant', Georgia, serif;" class="mobile-padding">
                            <h1 style="margin: 0 0 16px; color: #1A1A1A; font-size: 42px; font-weight: 300; line-height: 1.1; letter-spacing: -0.02em;" class="mobile-title">Order Shipped</h1>
                            <p style="margin: 0; color: #666666; font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase;">On Its Way to You</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 48px 64px 56px; font-family: 'Inter', sans-serif;" class="mobile-padding">
                            ...
                            <p style="margin: 0 0 48px; color: #4A4A4A; font-size: 16px; line-height: 1.7; font-weight: 300;" class="mobile-text">Your order #{{ $order->order_id }} has been shipped and is on its way to you.</p>

                            @if($order->tracking_number)
                            <!-- Tracking Info -->
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 48px;">
                                <tr>
                                    <td style="padding: 0 0 12px; color: #1A1A1A; font-size: 12px; font-weight: 500; letter-spacing: 0.05em; text-transform: uppercase;">Tracking Information</td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 0 16px; color: #666666; font-size: 14px; font-weight: 300;">Courier: {{ $order->shipping_courier ?? 'Standard Shipping' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 0 8px; color: #999999; font-size: 11px; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase;">Tracking Number</td>
                                </tr>
                                <tr>
                                    <td class="tracking-number" style="padding: 24px 28px; background: #F8F8F8; border-left: 2px solid #1A1A1A; color: #1A1A1A; font-size: 18px; font-weight: 500; letter-spacing: 0.05em; font-family: 'Courier New', monospace; word-break: break-all;">{{ $order->tracking_number }}</td>
                                </tr>
                            </table>
                            @endif
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="left">
                                        <a href="{{ route('my.orders') }}" style="display: inline-block; padding: 18px 48px; background-color: #1A1A1A; color: #FFFFFF; text-decoration: none; font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 500; letter-spacing: 0.08em; text-transform: uppercase; transition: background-color 0.2s ease;">Track Your Package</a>
                                    </td>
                                </tr>
                            </table>
