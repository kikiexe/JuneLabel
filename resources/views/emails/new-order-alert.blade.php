                ...
                <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" align="center" width="560" style="margin: auto; max-width: 560px; width: 100%; background: #FFFFFF;">
                    ...
                    <tr>
                        <td style="padding: 72px 64px 48px; font-family: 'Cormorant', Georgia, serif;" class="mobile-padding">
                            <h1 style="margin: 0 0 16px; color: #1A1A1A; font-size: 42px; font-weight: 300; line-height: 1.1; letter-spacing: -0.02em;" class="mobile-title">New Order</h1>
                            <p style="margin: 0; color: #666666; font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase;">Action Required</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 48px 64px 56px; font-family: 'Inter', sans-serif;" class="mobile-padding">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 40px;">
                                ...
                                <tr>
                                    <td style="padding: 20px 24px; background: #F8F8F8;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 0 0 8px; color: #999999; font-size: 11px; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase;">Customer</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding: 0 0 8px; color: #999999; font-size: 11px; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase;">Order Total</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 0 12px; color: #1A1A1A; font-size: 16px; font-weight: 500;">Rp {{ number_format($order->gross_amount, 0, ',', '.') }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding: 0; color: #666666; font-size: 14px; font-weight: 300;">{{ $order->payment_status->value ?? $order->payment_status }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 48px;">
                                <tr>
                                    <td colspan="2" style="padding: 0 0 16px; color: #1A1A1A; font-size: 12px; font-weight: 500; letter-spacing: 0.05em; text-transform: uppercase; border-bottom: 1px solid #E5E5E5;">Items</td>
                                </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 64px 56px; font-family: 'Inter', sans-serif;" class="mobile-padding">
                            ...
                            <p style="margin: 0; color: #CCCCCC; font-size: 12px; line-height: 1.6; font-weight: 300;">Automated notification</p>
                        </td>
                    </tr>
