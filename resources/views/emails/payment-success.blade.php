                ...
                <table role="presentation" class="email-container" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto; max-width: 600px; width: 100%; background: #ffffff; border-radius: 0; box-shadow: 0 4px 20px rgba(185, 162, 146, 0.12); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 50px 40px; text-align: center; background-color: #FAF4E5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;" class="mobile-header-padding">
                            ...
                            <h1 style="margin: 0 0 12px; color: #5a4a42; font-size: 34px; font-weight: 600; line-height: 1.2; letter-spacing: -0.5px;" class="mobile-font-xxl">Payment Confirmed</h1>
                            <p style="margin: 0; color: #8B7969; font-size: 17px; line-height: 1.5; font-weight: 400;" class="mobile-font-md">Thank you for your purchase</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 45px 45px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #ffffff;" class="mobile-padding">
                            ...
                            <p style="margin: 0 0 20px; color: #6b5d52; font-size: 16px; line-height: 1.7;" class="mobile-font-sm">We're delighted to confirm that your payment has been successfully processed for order <strong style="color: #5a4a42;">#{{ $order->order_id }}</strong>.</p>

                            <p style="margin: 0 0 35px; color: #6b5d52; font-size: 16px; line-height: 1.7;" class="mobile-font-sm">Our team is now carefully preparing your items. You'll receive a notification once your order has been shipped.</p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" class="mobile-btn" style="margin: 0 auto;">
                                <tr>
                                    <td style="border-radius: 6px; background-color: #B9A292; box-shadow: 0 4px 14px rgba(185, 162, 146, 0.30);">
                                        <a href="{{ route('my.orders') }}" style="display: inline-block; padding: 17px 45px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px; line-height: 1.4; letter-spacing: 0.3px;">Track Your Order</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #FAF4E5 0%, #E4E5DD 100%); border-radius: 8px; border: 1px solid #DEC7B5;">
                                <tr>
                                    <td style="padding: 28px;">
                                        <p style="margin: 0 0 10px; color: #6b5d52; font-size: 14px; line-height: 1.6;">Need assistance? Our customer service team is here to help you with any questions.</p>
